...
- FireFAirWConfig.cs: Example of ModConfig for custom mod settings;
- FireFAirWGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- FireFAirWMain.cs: Main mod class, recieves mod management and general events;
- FireFAirWTactical.cs: Example of ModTactical for modifying tactical level;
