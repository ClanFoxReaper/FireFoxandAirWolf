...
namespace FireFAirW
{
	...
	public class FireFAirWGSInstanceData
	{
	...
	/// </summary>
	public class FireFAirWGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new FireFAirWGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			FireFAirWGSInstanceData data = (FireFAirWGSInstanceData)instanceData;
		}
