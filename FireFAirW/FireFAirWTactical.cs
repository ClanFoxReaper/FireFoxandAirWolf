...
namespace FireFAirW
{
	...
	public class FireFAirWTacInstanceData
	{
	...
	/// </summary>
	public class FireFAirWTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			FireFAirWMain main = (FireFAirWMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			FireFAirWTacInstanceData data = (FireFAirWTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new FireFAirWTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
